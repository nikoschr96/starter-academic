...
# To use: copy your resume to `static/media/cv_christoforidis.pdf`, enable `ai` icons in `params.toml`, 
# and uncomment the lines below.
- icon: resume
  icon_pack: ai
  link: media/cv_christoforidis.pdf
...
{{< icon name="download" pack="fas" >}} Download my {{< staticref "media/cv_christoforidis.pdf" "newtab" >}}resume{{< /staticref >}}.
